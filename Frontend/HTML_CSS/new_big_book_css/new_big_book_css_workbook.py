...
#СХЕМА ВЫБОРА HTML5 ТЕГА:tinyurl.com/o298cs6
    ...
    #params
        ...
        action
        #думаю стоит указывать всегда, даже if ссылка ведет на туже страницу - выглядит более информативно: автор не просто забыл его, он намеренно создал ссылку на ту же страницу.
